...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        bottomLeftView.backgroundColor = circleColors[0];
        ...
        bottomRightView.backgroundColor = circleColors[1];
        ...
        topLeftView.backgroundColor = circleColors[2];
        ...
        topRightView.backgroundColor = circleColors[3];
